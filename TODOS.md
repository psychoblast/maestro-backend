...
| 0.1 | Voice mapping — fix in frontend CallScreen.js | 🔵 FRONTEND | Backend correct. Fix lives in ~/Desktop/ReveNation/ |
| 0.2 | Voice delay — verify /api/tts/synth wiring | 🔵 FRONTEND | Backend wired. Frontend verification pending |
| 0.3 | Audio stops on hangup — AbortController | 🔵 FRONTEND | Fix lives in ~/Desktop/ReveNation/ |
...
| **5** | E. Phase 0 device items | 🔵 SEPARATE SESSION | Twilio OTP (0.D), logcat (0.E), CallScreen.js (0.1/0.2/0.3). Physical device + ~/Desktop/ReveNation/ required. |
