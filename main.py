...
_AGENT_GREETINGS: dict[str, list[str]] = {
    "puppet-master": [
        "Hey, I'm Marcus — your Artist Manager. I run point on your entire career, from deals to team coordination. What's the most pressing thing on your plate right now?",
        "I'm Marcus, your Artist Manager. From contract strategy to connecting you with the right specialists, everything runs through me. What do you need to move on today?",
        "Marcus here — your Artist Manager. I've got full visibility across your operation: legal, finance, marketing, touring, all of it. What's going on with your career right now?",
        "Good to connect. I'm Marcus, your Artist Manager — every major decision, deal, and direction goes through me first. What's the priority today?",
        "I'm Marcus, your Artist Manager — strategy, deals, and your full team all run through me. I'm here whenever you need to think through a move. What's on your mind?",
    ],
    "lex-cipher": [
        "I'm Lex, your Entertainment Lawyer. I handle contracts, IP protection, and making sure no one takes advantage of you in a deal. What legal situation are we looking at?",
        "Lex here — your Entertainment Lawyer. Whether it's a record deal, publishing agreement, or a rights dispute, I've got you covered. What do you need reviewed?",
        "I'm Lex, your Entertainment Lawyer. I read every clause so you don't have to. What contract or legal question is on the table?",
    ],
    "fund-phantom": [
        "I'm Jade, your Grants and Funding specialist. I find and secure money that artists leave on the table — arts council grants, government funding, and private opportunities. What stage are you at?",
        "Jade here — I specialise in grants and arts funding. There's more money available for independent artists than most realise. Let's find what you qualify for.",
        "I'm Jade, your Funding specialist. From FACTOR to arts councils to private foundations, I know where the money is and how to apply for it. What do you need?",
    ],
    "rights-pulse": [
        "I'm Ray, your Performance Rights specialist. I make sure you're registered with the right PROs and collecting every penny you're owed in performance royalties. Where are we at?",
        "Ray here — Performance Rights. If you're not properly registered with your PRO, you're leaving money on the table every time your music plays. Let's sort that out.",
        "I'm Ray, your Performance Rights officer. PRO registration, performance royalties, live performance income — that's my world. What do you need to get set up?",
    ],
    "border-royalty": [
        "I'm Cleo, your Neighbouring Rights specialist. If your recordings are played on radio or in public spaces, you're owed money most artists never collect. Let's fix that.",
        "Cleo here — I handle Neighbouring Rights and international royalty collection. There's money sitting unclaimed in markets around the world with your name on it.",
        "I'm Cleo, your Neighbouring Rights advisor. Master recording royalties from broadcast and public performance are separate from your PRO income — and often overlooked. I'll walk you through it.",
    ],
    "mech-ledger": [
        "I'm Finn, your Mechanical Royalties specialist. Every time someone streams or downloads your music, mechanical royalties are generated. I make sure you collect all of them.",
        "Finn here — Mechanical Royalties. Whether it's streaming mechanicals, download licenses, or physical reproduction, I track the rates and make sure you're paid correctly.",
        "I'm Finn, your Mechanical Royalties advisor. Publishing income, licensing rates, Harry Fox, MLC — I handle the mechanical side of your publishing income. What do you need?",
    ],
    "vault-keeper": [
        "I'm Victor, your Business Manager. I oversee your finances at the macro level — budgets, cashflow, business structure, and making sure your money is working for you.",
        "Victor here — Business Management. Think of me as the CFO for your music career. I handle the financial strategy so you can focus on the music.",
        "I'm Victor, your Business Manager. Revenue planning, expense management, entity structure — I keep the business side of your career solid. What are we working on?",
    ],
    "ledger-lock": [
        "I'm Nadia, your Accountant. Tax returns, bookkeeping, royalty statement reconciliation — I make sure your numbers are clean and you keep as much of your income as legally possible.",
        "Nadia here — Accounting and Tax. Tour expenses, recording deductions, quarterly filings — I handle the detail work that protects your income. What do you need sorted?",
        "I'm Nadia, your Accountant. I specialise in music industry taxation — there are deductions most artists miss entirely. Let's make sure you're not one of them.",
    ],
    "signal-blaster": [
        "I'm Zara, your Publicist. Press coverage, media strategy, narrative control — I make sure the right people are talking about you in the right way. What's the story we're telling?",
        "Zara here — PR and Press. From release campaigns to crisis management, I handle your relationship with the media. What are we launching or protecting?",
        "I'm Zara, your Publicist. Blogs, magazines, radio interviews, editorial features — I open those doors and make sure you walk through them looking great. What do you need?",
    ],
    "grid-prophet": [
        "I'm Kai, your Digital Marketing specialist. Social growth, platform algorithms, paid campaigns — I turn your online presence into a career asset. What platform are we focused on?",
        "Kai here — Digital Marketing. TikTok strategy, Instagram growth, YouTube optimisation, Facebook ads — I know what moves the needle online for independent artists.",
        "I'm Kai, your Digital Marketing advisor. Data-driven growth across every platform. I'll show you exactly where to spend your time and money for maximum return.",
    ],
    "vision-forge": [
        "I'm Luna, your AI Visuals specialist. Album artwork, press photos, video thumbnails, brand visuals — I use AI tools to create professional-grade imagery at a fraction of the cost.",
        "Luna here — AI Visuals. Whether it's a full visual identity or a single cover, I use the latest AI image tools to bring your creative vision to life fast.",
        "I'm Luna, your AI Visuals advisor. I'll help you create a consistent, striking visual world for your music using the best AI image and video tools available.",
    ],
    "design-studio": [
        "I'm Diego, your Brand Designer. Logo, typography, colour palette, visual identity — I build the visual system that makes your brand instantly recognisable.",
        "Diego here — Visual Branding. From your first logo to a full brand overhaul, I create the visual language that represents who you are as an artist.",
        "I'm Diego, your Brand Designer. Merch layouts, press kits, social templates — everything looks consistent, professional, and unmistakably you. What are we building?",
    ],
    "venue-hawk": [
        "I'm Ray B, your Booking Agent. Venues, promoters, show deals, routing — I find the right stages and negotiate the right terms to build your live career.",
        "Ray B here — Global Booking. From local showcases to international tours, I know the venue landscape and the promoters who matter. What are we booking?",
        "I'm Ray B, your Booking Agent. A great live strategy builds your fanbase faster than almost anything else. Let's map out your live game plan.",
    ],
    "tour-commander": [
        "I'm Miles, your Tour Manager. Logistics, production, crew, travel, advancing — I handle everything that has to happen for a show to actually run smoothly.",
        "Miles here — Tour Management. Budget planning, venue advancing, crew hiring, day-of-show operations — I keep tours moving without the chaos. What are we planning?",
        "I'm Miles, your Tour Manager. From the first rehearsal to the last load-out, I make sure every show is executed professionally. What tour are we working on?",
    ],
    "airwave": [
        "I'm Solo, your Radio and Playlist specialist. Getting your music heard by the right programmers, curators, and playlist editors is what I do. What release are we pitching?",
        "Solo here — Radio and Playlist. Commercial radio, college radio, Spotify editorial, Apple Music playlists — I know the gatekeepers and how to reach them.",
        "I'm Solo, your Radio and Playlist advisor. A single playlist placement or radio spin can change your streaming numbers overnight. Let's build a pitching strategy.",
    ],
    "brand-connect": [
        "I'm Nia, your Brand Partnerships specialist. Sponsorships, endorsements, brand deals — I connect your image to brands that make sense and pay well. What's your brand like?",
        "Nia here — Brand Partnerships. From clothing brands to beverage companies to tech sponsors, I find deals that add to your credibility and your income.",
        "I'm Nia, your Brand Partnerships advisor. The right brand deal can fund a tour, boost your visibility, and expand your audience. Let's find your perfect partners.",
    ],
    "merch-empire": [
        "I'm Max, your Merchandise specialist. Design, production, fulfilment, pricing — I build merch operations that actually make money and don't leave you with boxes of unsold stock.",
        "Max here — Merchandise. From your first run of tees to a full product line, I handle the sourcing, production, and strategy to make your merch profitable.",
        "I'm Max, your Merch advisor. Great merch is a revenue stream, a marketing tool, and a fan loyalty system all in one. Let's build yours properly.",
    ],
    "fan-builder": [
        "I'm Aria, your Fan Engagement specialist. Community building, superfan strategy, fan clubs — I turn casual listeners into the loyal core that sustains a long career.",
        "Aria here — Fan Engagement. Discord communities, Patreon, fan newsletters, meet-and-greets — I create the systems that deepen the relationship between you and your fans.",
        "I'm Aria, your Fan Engagement advisor. A thousand true fans beats a million passive listeners every time. Let's build yours intentionally.",
    ],
    "sync-agent": [
        "I'm Sync, your Sync Licensing specialist. TV placements, film scores, advertising, video games — I get your music heard in places that pay well and expand your audience.",
        "Sync here — Sync Licensing. A single ad placement or TV sync can generate more income than months of streaming. I know the music supervisors who make those decisions.",
        "I'm Sync, your Sync Licensing advisor. I'll help you prepare your catalogue for sync, pitch to the right supervisors, and negotiate deals that respect your work.",
    ],
    "global-scout": [
        "I'm Nova, your International Markets specialist. Touring abroad, licensing in new territories, finding international partners — I open doors in markets where your music can grow.",
        "Nova here — International. The global music market is huge and most independent artists ignore 90% of it. I find the territories where your sound has real traction.",
        "I'm Nova, your International advisor. Distribution deals, foreign PRO registration, international touring strategy — I map out your global expansion one market at a time.",
    ],
    "creative-director": [
        "I'm Cree, your Creative Director. Release strategy, aesthetic vision, campaign rollout — I make sure every project you put out has a coherent creative identity that lands.",
        "Cree here — Creative Direction. The gap between a good song and a successful release is usually creative strategy. I close that gap. What are we releasing?",
        "I'm Cree, your Creative Director. From the first single rollout to the album campaign, I design the creative journey that turns a project into a cultural moment.",
    ],
    "data-oracle": [
        "I'm Data, your Analytics specialist. Streaming numbers, audience demographics, DSP insights — I translate the data into decisions that move your career forward.",
        "Data here — Analytics. Spotify for Artists, Apple Music Analytics, social insights — I know what the numbers mean and what you should do about them.",
        "I'm Data, your Analytics advisor. Your streaming data is telling you exactly where your fans are and what they want. Let's listen to it together.",
    ],
    "ar-scout": [
        "I'm Scout, your A&R advisor. Sound development, demo feedback, career positioning — I look at your music through the lens of the industry and help you develop your sound.",
        "Scout here — A&R. I give you the honest feedback that helps you grow, and the strategic advice that helps you find your place in the market.",
        "I'm Scout, your A&R specialist. From refining your sound to identifying what makes you unique in your lane — I help you become the artist you're capable of being.",
    ],
    "producer-connect": [
        "I'm Beat, your Production specialist. Producer connections, beat licensing, co-writing sessions, studio rates — I help you find the right collaborators and get the right deals.",
        "Beat here — Production. Whether you need a producer, a co-writer, or help negotiating a beat lease, I know the landscape and the right people in it.",
        "I'm Beat, your Production advisor. The right producer collaboration can define your sound for years. I help you find that match and structure it properly.",
    ],
    "music-edu": [
        "I'm Prof, your Music Business educator. Industry knowledge, terminology, how deals work, what to watch out for — I make sure you understand the business you're in.",
        "Prof here — Music Business Education. The more you understand how this industry works, the better decisions you make. Ask me anything you've been afraid to ask.",
        "I'm Prof, your Music Business advisor. From royalty splits to label structures to DIY strategies — I explain the music business clearly so you can navigate it confidently.",
    ],
    "collab-connect": [
        "I'm Collab, your Networking specialist. Artist collaborations, features, industry introductions — I help you build the relationships that open doors in this business.",
        "Collab here — Networking and Connections. The right feature, co-write, or industry introduction can change your career trajectory. I help you find and land those opportunities.",
        "I'm Collab, your Networking advisor. A strong network is as valuable as talent in this industry. Let's build yours strategically.",
    ],
    "artist-wellness": [
        "I'm Maya, your Wellness advisor. Mental health, burnout prevention, work-life balance — I make sure the demands of this career don't break the person behind the music.",
        "Maya here — Artist Wellness. The music industry is intense. I help artists build the mental and emotional resilience to sustain a long career without losing themselves.",
        "I'm Maya, your Wellness specialist. Touring stress, creative blocks, financial anxiety, relationship strain — these are real parts of this career. Let's talk about what you're carrying.",
    ],
    "press-monitor": [
        "I'm Press, your Media Monitor. I track every mention, review, and article about you so you always know what's being said and can respond strategically.",
        "Press here — Media Monitoring. Brand sentiment, press coverage, social mentions — I give you a real-time picture of your public narrative.",
        "I'm Press, your Media Monitor. Knowing what the media and public are saying about you is the first step to shaping the story. I keep you informed.",
    ],
    "live-coach": [
        "I'm Coach, your Performance Coach. Stage presence, vocal performance, crowd engagement, nerves — I help you become the performer your recorded music promises you are.",
        "Coach here — Performance Coaching. The gap between a good artist and a great live performer is coachable. I close that gap. What does your live show look like right now?",
        "I'm Coach, your Performance Coach. Whether you're about to play your first show or your hundredth, there's always room to become a more commanding performer.",
    ],
    "audio-quality": [
        "I'm Audio, your Quality Control specialist. Mix feedback, mastering standards, loudness levels, format requirements — I make sure your recordings meet professional release standards.",
        "Audio here — Quality Control. Before anything goes out, I listen with professional ears. Clarity, balance, punch, consistency — I'll tell you exactly where you stand.",
        "I'm Audio, your QC advisor. A bad mix can undermine a great song. I give you the honest technical feedback that helps your music compete at the highest level.",
    ],
    "ai-navigator": [
        "I'm Neo, your AI Tools specialist. From music generation to image creation to workflow automation — I know every AI tool that can save you time and money as an artist.",
        "Neo here — AI Tools and Automation. The AI landscape for musicians is moving fast. I help you find, learn, and use the right tools without the overwhelm.",
        "I'm Neo, your AI Navigator. Whether it's generating stems, creating visuals, writing bios, or automating your schedule — I'll show you exactly which AI tools to use and how.",
    ],
    "royalty-doctor": [
        "I'm Doc, your Royalty Recovery specialist. Unclaimed royalties, black box money, audit discrepancies — if you're owed money somewhere in the system, I find it and recover it.",
        "Doc here — Royalty Recovery. Most artists are owed more than they're collecting. I audit your royalty streams and track down everything that hasn't found its way to you.",
        "I'm Doc, your Royalty Doctor. From international black box funds to DSP underpayments — I've seen every way royalties go missing and I know how to get them back.",
    ],
    "video-director": [
        "I'm Reel, your Music Video strategist. Concept development, director sourcing, budget planning, distribution strategy — I help you make videos that serve your career.",
        "Reel here — Music Video. A great music video is a marketing asset, not just a creative project. I help you plan, produce, and maximise the impact of every video.",
        "I'm Reel, your Video Director advisor. From low-budget performance videos to fully produced visual pieces — I help you get the most out of every dollar you spend on visuals.",
    ],
    "mobile-monetize": [
        "I'm Mo, your Monetization specialist. TikTok Creator Fund, YouTube AdSense, Instagram monetization, Spotify fan tips — I help you activate every revenue stream on every platform.",
        "Mo here — Platform Monetization. Most artists leave significant money on digital platforms because they haven't set up their monetization properly. I fix that.",
        "I'm Mo, your Monetization advisor. From content ID to creator programs to direct-to-fan tools — I map out every platform revenue stream and help you turn them on.",
    ],
    "storefront": [
        "I'm Store, your Fan Store specialist. Direct-to-fan selling, digital downloads, exclusive content, memberships — I help you build a store that your fans actually want to buy from.",
        "Store here — Fan Commerce. Bandcamp, Shopify, Patreon, direct download links — I set up and optimise the systems that let you sell directly to your audience.",
        "I'm Store, your Fan Store advisor. Direct sales have the best margins in the music business. I help you build the storefront and the strategy to make it work.",
    ],
    "content-forge": [
        "I'm Pen, your Content Creation specialist. Bios, press releases, captions, liner notes, EPKs — I write the words that represent you professionally across every platform.",
        "Pen here — Content Creation. From a 150-character Instagram caption to a 1000-word artist bio, I make sure your written presence is as strong as your music.",
        "I'm Pen, your Content advisor. Great content strategy means the right words in the right places at the right time. I handle the writing so you can focus on the music.",
    ],
    "schedule-keeper": [
        "I'm Cal, your Scheduling specialist. Release calendars, content schedules, deadline management, campaign timelines — I keep your career moving at the right pace.",
        "Cal here — Scheduling and Planning. A good release campaign lives or dies on timing. I build the calendars and systems that keep everything on track.",
        "I'm Cal, your Schedule Keeper. From album rollouts to social content plans to studio booking — I map out the timeline and make sure nothing falls through the cracks.",
    ],
    "ink-and-air": [
        "Reed here — Music Publishing. Your songs are assets. I make sure you own them, register them correctly, and get paid every time they're used.",
        "I'm Reed, your Music Publisher. Publishing deals, sync licensing, songwriting royalties — I protect your catalog and maximize what it earns.",
        "Reed, Publishing. Most artists leave serious money on the table because their publishing isn't set up right. Let's fix that.",
    ],
    "live-wire": [
        "Knox here — Booking Agent. Live shows, festivals, touring strategy — I get you on stage and make sure the money is right when you get there.",
        "I'm Knox, your Booking Agent. From local venues to major festivals, I handle the pitches, the contracts, and the performance fees.",
        "Knox, Bookings. A strong live presence builds your fanbase faster than anything else. Let's talk about where you should be performing.",
    ],
    "label-services": [
        "Tommy here — Label Services. Distribution, release planning, DSP delivery, label setup — I make sure your music gets out to the world correctly and on time.",
        "I'm Tommy, your Label Services Manager. From DistroKid to proper label distribution, I handle the infrastructure that gets your music on every platform.",
        "Tommy, Label Services. A great song needs a great release strategy behind it. Let's talk about your next drop and make sure everything is set up right.",
    ],
}
...
async def send_otp(payload: SendOtpRequest):
    ...
    try:
        ...
        twilio.messages.create(
            body=f"Your [scrubbed] NATION code is {otp}. Valid for 10 minutes.",
            from_=from_number,
            to=phone,
        )
